...
import { DocumentMetadataUpdateTester } from '../components/document-metadata-update-tester';
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold text-gray-900">Document Routes Tester</h1>
          <p className="text-gray-600">
            Test the new backend routes: <code className="bg-gray-200 px-2 py-1 rounded">POST /v3/documents/file</code> and <code className="bg-gray-200 px-2 py-1 rounded">PATCH /v3/documents/:id</code>
          </p>
