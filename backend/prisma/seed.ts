...
async function main() {
    ...
    const [doc1, doc2, doc3] = await Promise.all([
        prisma.document.create({
            data: {
                ...
                content: "Welcome to Project Alpha. This document outlines the project goals, timeline, and key stakeholders for the first quarter of 2025.",
                orgId: "org_123",
                userId: "user_abc",
                source: "Google Drive",
                type: "google_doc",
        ...
        prisma.document.create({
            data: {
                ...
                summary: "This report covers the performance metrics of our web application, focusing on load times and user engagement.",
                orgId: "org_123",
                userId: "user_abc",
    ...
    const [mem1, mem2, mem3] = await Promise.all([
        ...
        prisma.memoryEntry.create({
            data: {
                id: "mem_seed_03",
                memory: "Users have reported that the web app's initial load time can exceed 3 seconds on slow connections.",
                spaceId: space2.id,
                orgId: "org_123",
                userId: "user_abc",
            },
